...
def update_and_solve(c_S_T1, c_T1_T2, c_T2_D, supply_capacities, modified_quantities=None):
    
    mod_demand = modified_quantities if modified_quantities else demand_quantities
    return transshipment_problem(supply_capacities, mod_demand, c_S_T1, c_T1_T2, c_T2_D)
